...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-11-09 19:02:11',NULL),('diagnostics.include_raw','OFF','2024-11-09 19:02:11',NULL),('ps_thread_trx_info.max_length','65535','2024-11-09 19:02:11',NULL),('statement_performance_analyzer.limit','100','2024-11-09 19:02:11',NULL),('statement_performance_analyzer.view',NULL,'2024-11-09 19:02:11',NULL),('statement_truncate_len','64','2024-11-09 19:02:11',NULL);
...
-- Dump completed on 2024-11-10  9:19:35
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: koozie
-- ------------------------------------------------------
-- Server version	8.0.40
...
INSERT INTO `circles` VALUES (9,'Anime'),(12,'Chemistry'),(14,'IT'),(13,'Physics'),(10,'Robotics'),(8,'Soccer'),(7,'Tennis'),(11,'Theatre');
/*!40000 ALTER TABLE `circles` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `circles_to_keywords`
--

DROP TABLE IF EXISTS `circles_to_keywords`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `circles_to_keywords` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `circles_to_keywords`
--

LOCK TABLES `circles_to_keywords` WRITE;
/*!40000 ALTER TABLE `circles_to_keywords` DISABLE KEYS */;
/*!40000 ALTER TABLE `circles_to_keywords` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `circles_to_messages`
--

DROP TABLE IF EXISTS `circles_to_messages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `circles_to_messages` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `circles_to_messages`
--

LOCK TABLES `circles_to_messages` WRITE;
/*!40000 ALTER TABLE `circles_to_messages` DISABLE KEYS */;
INSERT INTO `circles_to_messages` VALUES (34,7,42),(35,7,43),(36,7,44),(37,7,45),(38,7,46),(39,7,47),(40,7,48),(41,7,49);
/*!40000 ALTER TABLE `circles_to_messages` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `keywords` (
  `id` int NOT NULL AUTO_INCREMENT,
  `keyword` varchar(225) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
...
INSERT INTO `keywords` VALUES (5,'Tennis'),(6,'Sport'),(7,'Soccer'),(8,'Sport'),(9,'active'),(10,'loh'),(11,'engineering'),(12,'computer science'),(13,'robots'),(14,'theatre'),(15,'art'),(16,'actor'),(17,'music'),(18,'chem'),(19,'biology'),(20,'organics'),(21,'science'),(22,'VERY HARD'),(23,'science'),(24,'math'),(25,'BEST'),(26,'computer'),(27,'programming'),(28,'hacking'),(29,'math'),(30,'algorithms');
...
INSERT INTO `messages` VALUES (42,'user1','hello, how are you al doing?'),(43,'user2','hi, everything is nice'),(44,'user3','do u like tennis?'),(45,'user1','yeah, ofc'),(46,'user4','Don\'t really think it\'s a nice sport'),(47,'user5','Then what are u doing in this chat?'),(48,'user1','who is ready to play tennis?'),(49,'user2','i can join you');
...
INSERT INTO `users` VALUES (4,'user1','$2b$12$1VMx7UBSCAMU/qgVU8VwderKhvhC4Z90Q714ZJ22hN.xI6BsG8Wpy','Ilya','Shilov'),(5,'user2','$2b$12$iJsL.ZCDgTEKah7VRc0RUOXjdIsMi1Ji.1d0I3MTjHwwqJT4toJPa','Slava','Pomeshchikov'),(6,'user3','$2b$12$ZrdkbJicH3KwxHiGe60WGeRh1a7ekZ0J07L5/j4y7vPT06XhITT5u','Grisha','Kozhemiaca'),(7,'user4','$2b$12$1Dn0DT9756bT9flKtsk7UO696HrEOCVMh9rPes97jRJX7GUaraMBq','Daulet','Mukan'),(8,'user5','$2b$12$cVxhl0ZJdXjewI5K41/iE.qddj2fLSaVvY4JGx/V2USEgylHqFUVK','Liza','Kuzmina');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `users_to_circles`
--

DROP TABLE IF EXISTS `users_to_circles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `users_to_circles` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `users_to_circles`
--

LOCK TABLES `users_to_circles` WRITE;
/*!40000 ALTER TABLE `users_to_circles` DISABLE KEYS */;
/*!40000 ALTER TABLE `users_to_circles` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
